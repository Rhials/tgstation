#define TOOLBOXCALIBUR_WORTHY_FORCE 30
#define TOOLBOXCALIBUR_WORTHY_THROW_FORCE 45
#define TOOLBOXCALIBUR_WORTHY_THROW_RANGE 10
...
/obj/item/toolboxcalibur
	name = "Toolboxcalibur"
	desc = "The mythical <b>Toolboxcalibur</b>. Its completely absurd design makes it near impossible to properly wield or swing in a fight. Fortunately, it's also so incredibly heavy that even a glancing blow will obliterate its target. \
	...
	throw_range = TOOLBOXCALIBUR_WORTHY_THROW_RANGE
