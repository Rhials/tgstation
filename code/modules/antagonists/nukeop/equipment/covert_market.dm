...
/obj/item/covert_market/proc/on_war_rejection()
	...
	var/datum/component/uplink/new_uplink = src.AddComponent(/datum/component/uplink, src)
	new_uplink.name = "covert operations bargain market"
